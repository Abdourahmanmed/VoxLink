...
export default function ReponduState() {
    // state
    const [QuickPoste, setQuickPoste] = useState<TousLescontact[]>([])

    //comportement 
    const fetchAllRepondu = async () => {
        const apiUrl = `http://192.168.100.4:8080/Vox_Backend//api.php?method=AfficherTousLesAppelsRepondu`;
        try {
