...
export default function TousLeRappels() {
    // state
    const [QuickPoste, setQuickPoste] = useState<TousLescontact[]>([])

    //comportement 
    const fetchAllRapeller = async () => {
        const apiUrl = `http://192.168.100.4:8080/Vox_Backend//api.php?method=AfficherTousLesAppels`;
        try {
